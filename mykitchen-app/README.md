...
My App's purpose is for a user to collect Recipes in a centralized place and be able to add a new recipes, its image and its description when needed. The app also can delete a recipe that is no longer wanted.
